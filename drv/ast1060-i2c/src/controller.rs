...
use crate::timing::configure_timing;
use crate::*;
use ast1060_pac::{
    i2c::RegisterBlock, i2cbuff::RegisterBlock as BuffRegisterBlock,
};
...
impl<'a> Ast1060I2c<'a> {
    ...
    pub fn is_bus_busy(&self) -> bool {
        ...
        (status & (AST_I2CM_TX_CMD | AST_I2CM_RX_CMD | AST_I2CM_START_CMD)) != 0
    }

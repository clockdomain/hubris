...
//!
//! This module wraps the drv-ast1060-i2c driver to provide the I2cHardware trait
//! implementation for the openprot-i2c-server.
...
impl I2cHardware for Ast1060I2cDriver {
    ...
    fn configure_slave_mode(
        ...
        #[cfg(feature = "slave")]
        {
            ...
            let slave_cfg = drv_ast1060_i2c::SlaveConfig::new(config.address)

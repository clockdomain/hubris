...
use drv_i2c_mux_core::{pca9548::Pca9548 as GenericPca9548, I2cMuxConfig, I2cMuxDriver as GenericI2cMuxDriver};
...
impl I2cMuxDriver for Pca9548 {
    fn configure(
        ...
        let generic_driver = GenericPca9548;
        ...
        <GenericPca9548 as GenericI2cMuxDriver<Stm32I2cHardware<'_>, Stm32GpioPin<'_>>>::configure(&generic_driver, &mut config)
    }
    ...
    fn enable_segment(
        ...
        match <GenericPca9548 as GenericI2cMuxDriver<Stm32I2cHardware<'_>, Stm32GpioPin<'_>>>::enable_segment(&generic_driver, &mut i2c_hardware, &config, segment) {
    ...
    fn reset(
        ...
        <GenericPca9548 as GenericI2cMuxDriver<Stm32I2cHardware<'_>, Stm32GpioPin<'_>>>::reset(&generic_driver, &mut config)
    }
}
